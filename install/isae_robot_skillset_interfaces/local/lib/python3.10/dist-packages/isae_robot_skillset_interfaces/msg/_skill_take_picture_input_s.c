...
bool isae_robot_skillset_interfaces__msg__skill_take_picture_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_take_picture_input.SkillTakePictureInput", full_classname_dest, 82) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillTakePictureInput * ros_message = _ros_message;
  {  // object_name
    PyObject * field = PyObject_GetAttrString(_pymsg, "object_name");
    if (!field) {
      return false;
    }
    if (!std_msgs__msg__string__convert_from_py(field, &ros_message->object_name)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SkillTakePictureInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_take_picture_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillTakePictureInput");
  ...
  {  // object_name
    PyObject * field = NULL;
    field = std_msgs__msg__string__convert_to_py(&ros_message->object_name);
    if (!field) {
      return NULL;
    }
    {
