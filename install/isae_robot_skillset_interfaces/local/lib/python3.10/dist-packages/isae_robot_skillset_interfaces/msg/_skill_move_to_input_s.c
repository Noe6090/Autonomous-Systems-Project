...
bool isae_robot_skillset_interfaces__msg__skill_move_to_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_move_to_input.SkillMoveToInput", full_classname_dest, 72) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillMoveToInput * ros_message = _ros_message;
  {  // target
    PyObject * field = PyObject_GetAttrString(_pymsg, "target");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__pose2_d__convert_from_py(field, &ros_message->target)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SkillMoveToInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_move_to_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillMoveToInput");
  ...
  {  // target
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose2_d__convert_to_py(&ros_message->target);
    if (!field) {
      return NULL;
    }
    {
