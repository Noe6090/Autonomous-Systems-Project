...
bool isae_robot_skillset_interfaces__msg__skill_track_target_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_track_target_request.SkillTrackTargetRequest", full_classname_dest, 86) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillTrackTargetRequest * ros_message = _ros_message;
  {  // id
  ...
  {  // input
    ...
    if (!isae_robot_skillset_interfaces__msg__skill_track_target_input__convert_from_py(field, &ros_message->input)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SkillTrackTargetRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_track_target_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillTrackTargetRequest");
  ...
  {  // input
    PyObject * field = NULL;
    field = isae_robot_skillset_interfaces__msg__skill_track_target_input__convert_to_py(&ros_message->input);
    if (!field) {
      return NULL;
    }
    {
