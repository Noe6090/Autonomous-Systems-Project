...
bool isae_robot_skillset_interfaces__msg__event_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._event_request.EventRequest", full_classname_dest, 62) == 0);
  }
  isae_robot_skillset_interfaces__msg__EventRequest * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of EventRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._event_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EventRequest");
