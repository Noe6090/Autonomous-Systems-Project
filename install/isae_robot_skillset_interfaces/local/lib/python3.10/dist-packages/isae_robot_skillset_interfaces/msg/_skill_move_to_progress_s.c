...
bool isae_robot_skillset_interfaces__msg__skill_move_to_progress__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_move_to_progress.SkillMoveToProgress", full_classname_dest, 78) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillMoveToProgress * ros_message = _ros_message;
  {  // id
  ...
  {  // distance
    ...
    if (!std_msgs__msg__float64__convert_from_py(field, &ros_message->distance)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SkillMoveToProgress */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_move_to_progress");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillMoveToProgress");
  ...
  {  // distance
    PyObject * field = NULL;
    field = std_msgs__msg__float64__convert_to_py(&ros_message->distance);
    if (!field) {
      return NULL;
    }
    {
