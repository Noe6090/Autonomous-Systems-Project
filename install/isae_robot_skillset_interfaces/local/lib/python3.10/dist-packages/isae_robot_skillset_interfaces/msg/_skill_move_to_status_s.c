...
bool isae_robot_skillset_interfaces__msg__skill_move_to_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_move_to_status.SkillMoveToStatus", full_classname_dest, 74) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillMoveToStatus * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of SkillMoveToStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_move_to_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillMoveToStatus");
