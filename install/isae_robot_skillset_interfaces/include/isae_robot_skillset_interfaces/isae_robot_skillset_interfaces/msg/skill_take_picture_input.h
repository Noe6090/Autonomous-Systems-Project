...
#ifndef ISAE_ROBOT_SKILLSET_INTERFACES__MSG__SKILL_TAKE_PICTURE_INPUT_H_
#define ISAE_ROBOT_SKILLSET_INTERFACES__MSG__SKILL_TAKE_PICTURE_INPUT_H_
...
#endif  // ISAE_ROBOT_SKILLSET_INTERFACES__MSG__SKILL_TAKE_PICTURE_INPUT_H_
