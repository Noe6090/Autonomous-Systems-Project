...
isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__init(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__fini(msg);
    return false;
  }
  // id
...
isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__create()
{
  ...
  isae_robot_skillset_interfaces__msg__SkillTakePictureStatus * msg = (isae_robot_skillset_interfaces__msg__SkillTakePictureStatus *)allocator.allocate(sizeof(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus));
  bool success = isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__init(msg);
  if (!success) {
...
isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence__init(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isae_robot_skillset_interfaces__msg__SkillTakePictureStatus * data = NULL;

  if (size) {
    data = (isae_robot_skillset_interfaces__msg__SkillTakePictureStatus *)allocator.zero_allocate(size, sizeof(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__fini(&data[i - 1]);
      }
...
isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence__fini(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence * array = (isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence *)allocator.allocate(sizeof(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence__init(array, size);
  if (!success) {
...
isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence__destroy(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence__are_equal(const isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence * lhs, const isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(isae_robot_skillset_interfaces__msg__SkillTakePictureStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    isae_robot_skillset_interfaces__msg__SkillTakePictureStatus * data =
      (isae_robot_skillset_interfaces__msg__SkillTakePictureStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          isae_robot_skillset_interfaces__msg__SkillTakePictureStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
