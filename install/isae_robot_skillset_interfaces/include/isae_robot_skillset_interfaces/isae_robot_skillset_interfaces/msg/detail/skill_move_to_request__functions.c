...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__init(isae_robot_skillset_interfaces__msg__SkillMoveToRequest * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->id)) {
    isae_robot_skillset_interfaces__msg__SkillMoveToRequest__fini(msg);
    return false;
  }
  // input
  if (!isae_robot_skillset_interfaces__msg__SkillMoveToInput__init(&msg->input)) {
    isae_robot_skillset_interfaces__msg__SkillMoveToRequest__fini(msg);
    return false;
  }
  return true;
...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__fini(isae_robot_skillset_interfaces__msg__SkillMoveToRequest * msg)
{
  ...
  // input
  isae_robot_skillset_interfaces__msg__SkillMoveToInput__fini(&msg->input);
}
...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__are_equal(const isae_robot_skillset_interfaces__msg__SkillMoveToRequest * lhs, const isae_robot_skillset_interfaces__msg__SkillMoveToRequest * rhs)
{
  ...
  // input
  if (!isae_robot_skillset_interfaces__msg__SkillMoveToInput__are_equal(
      &(lhs->input), &(rhs->input)))
  {
    return false;
  }
...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__create()
{
  ...
  isae_robot_skillset_interfaces__msg__SkillMoveToRequest * msg = (isae_robot_skillset_interfaces__msg__SkillMoveToRequest *)allocator.allocate(sizeof(isae_robot_skillset_interfaces__msg__SkillMoveToRequest), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(isae_robot_skillset_interfaces__msg__SkillMoveToRequest));
  bool success = isae_robot_skillset_interfaces__msg__SkillMoveToRequest__init(msg);
  if (!success) {
...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence__init(isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isae_robot_skillset_interfaces__msg__SkillMoveToRequest * data = NULL;

  if (size) {
    data = (isae_robot_skillset_interfaces__msg__SkillMoveToRequest *)allocator.zero_allocate(size, sizeof(isae_robot_skillset_interfaces__msg__SkillMoveToRequest), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = isae_robot_skillset_interfaces__msg__SkillMoveToRequest__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        isae_robot_skillset_interfaces__msg__SkillMoveToRequest__fini(&data[i - 1]);
      }
...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence__fini(isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      isae_robot_skillset_interfaces__msg__SkillMoveToRequest__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence * array = (isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence *)allocator.allocate(sizeof(isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence__init(array, size);
  if (!success) {
...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence__destroy(isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence__are_equal(const isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence * lhs, const isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!isae_robot_skillset_interfaces__msg__SkillMoveToRequest__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  isae_robot_skillset_interfaces__msg__SkillMoveToRequest__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(isae_robot_skillset_interfaces__msg__SkillMoveToRequest);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    isae_robot_skillset_interfaces__msg__SkillMoveToRequest * data =
      (isae_robot_skillset_interfaces__msg__SkillMoveToRequest *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!isae_robot_skillset_interfaces__msg__SkillMoveToRequest__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          isae_robot_skillset_interfaces__msg__SkillMoveToRequest__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!isae_robot_skillset_interfaces__msg__SkillMoveToRequest__copy(
