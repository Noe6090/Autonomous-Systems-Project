...
#include "isae_robot_skillset_interfaces/msg/detail/resource_state__rosidl_typesupport_fastrtps_c.h"
...
using _ResourceState__ros_msg_type = isae_robot_skillset_interfaces__msg__ResourceState;
...
static uint32_t _ResourceState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_isae_robot_skillset_interfaces__msg__ResourceState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isae_robot_skillset_interfaces__msg__ResourceState;
    is_plain =
      (
...
static size_t _ResourceState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_isae_robot_skillset_interfaces__msg__ResourceState(
