...
#include "isae_robot_skillset_interfaces/msg/detail/skill_move_to_response__rosidl_typesupport_fastrtps_c.h"
...
using _SkillMoveToResponse__ros_msg_type = isae_robot_skillset_interfaces__msg__SkillMoveToResponse;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SkillMoveToResponse__ros_msg_type * ros_message = static_cast<const _SkillMoveToResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SkillMoveToResponse__ros_msg_type * ros_message = static_cast<_SkillMoveToResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_isae_robot_skillset_interfaces__msg__SkillMoveToResponse(
  const void * untyped_ros_message,
...
static uint32_t _SkillMoveToResponse__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_isae_robot_skillset_interfaces__msg__SkillMoveToResponse(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isae_robot_skillset_interfaces
size_t max_serialized_size_isae_robot_skillset_interfaces__msg__SkillMoveToResponse(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isae_robot_skillset_interfaces__msg__SkillMoveToResponse;
    is_plain =
      (
...
static size_t _SkillMoveToResponse__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_isae_robot_skillset_interfaces__msg__SkillMoveToResponse(
...
static message_type_support_callbacks_t __callbacks_SkillMoveToResponse = {
...
static rosidl_message_type_support_t _SkillMoveToResponse__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SkillMoveToResponse,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isae_robot_skillset_interfaces, msg, SkillMoveToResponse)() {
  return &_SkillMoveToResponse__type_support;
}
