...
bool isae_robot_skillset_interfaces__msg__skill_track_target_progress__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_track_target_progress.SkillTrackTargetProgress", full_classname_dest, 88) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillTrackTargetProgress * ros_message = _ros_message;
  {  // id
  ...
  {  // detection
    ...
    if (!geometry_msgs__msg__pose2_d__convert_from_py(field, &ros_message->detection)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SkillTrackTargetProgress */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_track_target_progress");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillTrackTargetProgress");
  ...
  {  // detection
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose2_d__convert_to_py(&ros_message->detection);
    if (!field) {
      return NULL;
    }
    {
