...
bool isae_robot_skillset_interfaces__msg__skill_detect_target_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_detect_target_input.SkillDetectTargetInput", full_classname_dest, 84) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillDetectTargetInput * ros_message = _ros_message;
  {  // timeout
...
{
  /* NOTE(esteve): Call constructor of SkillDetectTargetInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_detect_target_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillDetectTargetInput");
