...
bool isae_robot_skillset_interfaces__msg__data_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._data_pose.DataPose", full_classname_dest, 54) == 0);
  }
  isae_robot_skillset_interfaces__msg__DataPose * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of DataPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._data_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DataPose");
