...
bool isae_robot_skillset_interfaces__msg__event_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._event_response.EventResponse", full_classname_dest, 64) == 0);
  }
  isae_robot_skillset_interfaces__msg__EventResponse * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of EventResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._event_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EventResponse");
