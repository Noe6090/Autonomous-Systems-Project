...
bool isae_robot_skillset_interfaces__msg__resource_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._resource_state.ResourceState", full_classname_dest, 64) == 0);
  }
  isae_robot_skillset_interfaces__msg__ResourceState * ros_message = _ros_message;
  {  // name
...
PyObject * isae_robot_skillset_interfaces__msg__resource_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._resource_state");
