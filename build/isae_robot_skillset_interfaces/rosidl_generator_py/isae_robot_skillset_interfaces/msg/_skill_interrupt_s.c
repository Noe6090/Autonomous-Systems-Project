...
bool isae_robot_skillset_interfaces__msg__skill_interrupt__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_interrupt.SkillInterrupt", full_classname_dest, 66) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillInterrupt * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of SkillInterrupt */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_interrupt");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillInterrupt");
