...
bool isae_robot_skillset_interfaces__msg__skill_detect_target_output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isae_robot_skillset_interfaces.msg._skill_detect_target_output.SkillDetectTargetOutput", full_classname_dest, 86) == 0);
  }
  isae_robot_skillset_interfaces__msg__SkillDetectTargetOutput * ros_message = _ros_message;
  {  // target
    PyObject * field = PyObject_GetAttrString(_pymsg, "target");
    if (!field) {
      return false;
    }
    if (!std_msgs__msg__string__convert_from_py(field, &ros_message->target)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SkillDetectTargetOutput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isae_robot_skillset_interfaces.msg._skill_detect_target_output");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SkillDetectTargetOutput");
  ...
  {  // target
    PyObject * field = NULL;
    field = std_msgs__msg__string__convert_to_py(&ros_message->target);
    if (!field) {
      return NULL;
    }
    {
