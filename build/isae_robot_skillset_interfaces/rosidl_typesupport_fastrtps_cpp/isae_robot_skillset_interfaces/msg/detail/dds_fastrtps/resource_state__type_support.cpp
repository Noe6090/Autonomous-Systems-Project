...
#include "isae_robot_skillset_interfaces/msg/detail/resource_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const isae_robot_skillset_interfaces::msg::ResourceState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  isae_robot_skillset_interfaces::msg::ResourceState & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isae_robot_skillset_interfaces::msg::ResourceState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const isae_robot_skillset_interfaces::msg::ResourceState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<isae_robot_skillset_interfaces::msg::ResourceState *>(
    untyped_ros_message);
...
{
  return &isae_robot_skillset_interfaces::msg::typesupport_fastrtps_cpp::_ResourceState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isae_robot_skillset_interfaces, msg, ResourceState)() {
  return &isae_robot_skillset_interfaces::msg::typesupport_fastrtps_cpp::_ResourceState__handle;
}
