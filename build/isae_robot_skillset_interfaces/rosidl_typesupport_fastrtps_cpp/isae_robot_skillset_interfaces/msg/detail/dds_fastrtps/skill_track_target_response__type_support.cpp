...
#include "isae_robot_skillset_interfaces/msg/detail/skill_track_target_response__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const isae_robot_skillset_interfaces::msg::SkillTrackTargetResponse & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  isae_robot_skillset_interfaces::msg::SkillTrackTargetResponse & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_isae_robot_skillset_interfaces
max_serialized_size_SkillTrackTargetResponse(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isae_robot_skillset_interfaces::msg::SkillTrackTargetResponse;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const isae_robot_skillset_interfaces::msg::SkillTrackTargetResponse *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<isae_robot_skillset_interfaces::msg::SkillTrackTargetResponse *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SkillTrackTargetResponse__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const isae_robot_skillset_interfaces::msg::SkillTrackTargetResponse *>(
...
static size_t _SkillTrackTargetResponse__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SkillTrackTargetResponse(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SkillTrackTargetResponse__callbacks = {
...
static rosidl_message_type_support_t _SkillTrackTargetResponse__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SkillTrackTargetResponse__callbacks,
...
{
  return &isae_robot_skillset_interfaces::msg::typesupport_fastrtps_cpp::_SkillTrackTargetResponse__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isae_robot_skillset_interfaces, msg, SkillTrackTargetResponse)() {
  return &isae_robot_skillset_interfaces::msg::typesupport_fastrtps_cpp::_SkillTrackTargetResponse__handle;
}
