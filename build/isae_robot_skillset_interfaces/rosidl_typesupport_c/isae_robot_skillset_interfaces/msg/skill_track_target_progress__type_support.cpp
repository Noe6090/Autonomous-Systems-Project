...
static const _SkillTrackTargetProgress_type_support_symbol_names_t _SkillTrackTargetProgress_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isae_robot_skillset_interfaces, msg, SkillTrackTargetProgress)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isae_robot_skillset_interfaces, msg, SkillTrackTargetProgress)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isae_robot_skillset_interfaces, msg, SkillTrackTargetProgress)() {
  return &::isae_robot_skillset_interfaces::msg::rosidl_typesupport_c::SkillTrackTargetProgress_message_type_support_handle;
}
