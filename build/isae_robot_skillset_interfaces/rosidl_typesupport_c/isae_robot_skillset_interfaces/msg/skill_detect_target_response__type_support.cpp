...
static const _SkillDetectTargetResponse_type_support_symbol_names_t _SkillDetectTargetResponse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isae_robot_skillset_interfaces, msg, SkillDetectTargetResponse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isae_robot_skillset_interfaces, msg, SkillDetectTargetResponse)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isae_robot_skillset_interfaces, msg, SkillDetectTargetResponse)() {
  return &::isae_robot_skillset_interfaces::msg::rosidl_typesupport_c::SkillDetectTargetResponse_message_type_support_handle;
}
