...
static const _SkillMoveToResponse_type_support_symbol_names_t _SkillMoveToResponse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isae_robot_skillset_interfaces, msg, SkillMoveToResponse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, isae_robot_skillset_interfaces, msg, SkillMoveToResponse)),
  }
};
...
{
  return &::isae_robot_skillset_interfaces::msg::rosidl_typesupport_cpp::SkillMoveToResponse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, isae_robot_skillset_interfaces, msg, SkillMoveToResponse)() {
  return get_message_type_support_handle<isae_robot_skillset_interfaces::msg::SkillMoveToResponse>();
}
