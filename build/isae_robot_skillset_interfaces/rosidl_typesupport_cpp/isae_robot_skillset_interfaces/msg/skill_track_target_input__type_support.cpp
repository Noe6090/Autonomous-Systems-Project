...
static const _SkillTrackTargetInput_type_support_symbol_names_t _SkillTrackTargetInput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isae_robot_skillset_interfaces, msg, SkillTrackTargetInput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, isae_robot_skillset_interfaces, msg, SkillTrackTargetInput)),
  }
};
...
{
  return &::isae_robot_skillset_interfaces::msg::rosidl_typesupport_cpp::SkillTrackTargetInput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, isae_robot_skillset_interfaces, msg, SkillTrackTargetInput)() {
  return get_message_type_support_handle<isae_robot_skillset_interfaces::msg::SkillTrackTargetInput>();
}
